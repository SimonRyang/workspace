...
contains
  ...
  function cons_e(x_in)
      ...
      ! variable declarations
      real*8 :: cons_e, X_plus, tomorrow, varphi_x, varphi_p
      ...
      tomorrow = max(varphi_x*varphi_p              *(egam*S(ij_com, ixl_p, ipl_p, ik_com, iw_com, ie_com, 1))**(1d0/egam) +  &
                     varphi_x*(1d0-varphi_p)        *(egam*S(ij_com, ixl_p, ipr_p, ik_com, iw_com, ie_com, 1))**(1d0/egam) +  &
                     (1d0-varphi_x)*varphi_p        *(egam*S(ij_com, ixr_p, ipl_p, ik_com, iw_com, ie_com, 1))**(1d0/egam) +  &
                     (1d0-varphi_x)*(1d0-varphi_p)  *(egam*S(ij_com, ixr_p, ipr_p, ik_com, iw_com, ie_com, 1))**(1d0/egam), 1d-10)**egam/egam
