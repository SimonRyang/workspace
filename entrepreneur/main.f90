...
contains
  ...
  subroutine initialize()
    ...
    call discretize_AR(0.9360d0**5d0, -0.500d0, sigma5(0.9360d0, 0.0375d0), theta(:, 2), pi_theta(:, :, 2), dist_theta(:, 2))
    theta(:, 2) = exp(theta(:, 2))!/sum(dist_theta(:, 2)*exp(theta(:, 2)))

    call discretize_AR(0.9450d0**5d0, -0.250d0, sigma5(0.9450d0, 0.0385d0), theta(:, 3), pi_theta(:, :, 3), dist_theta(:, 3))
