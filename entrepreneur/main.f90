program main
  ...
  nu = 0.88d0
  l_bar = 0.47d0
  suc = 1d0 - 0.10d0 !(1d0 - 0.50d0)**(1d0-gamma)
  swc = 1d0 - 0.10d0 !(1d0 - 0.50d0)**(1d0-gamma)
  ! convert variables into per period values
...
contains
  ...
  subroutine initialize()
    ...
    call discretize_AR(0.9400d0**5d0, -0.0500d0, sigma5(0.9400d0, 0.0370d0), theta(:, 1), pi_theta(:, :, 1), dist_theta(:, 1))
