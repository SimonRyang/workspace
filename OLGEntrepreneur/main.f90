              ...
              do ix = 0, NX
                do ik = 0, NK
                  do ia = 0, NA
                    ...
                    AA(it) = AA(it) + aplus(ia, ik, ix, ip, iw, ie, is, ij, itm)*m(ia, ik, ix, ip, iw, ie, is, ij, itm)
                    ...
                    BQS(is, it) = BQS(is, it) + (1d0+r(it))*aplus(ia, ik, ix, ip, iw, ie, is, ij, itm)*(1d0-psi(is, ij+1))*m(ia, ik, ix, ip, iw, ie, is, ij, itm)
