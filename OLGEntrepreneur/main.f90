              ...
              do ix = 0, NX
                do ik = 0, NK
                  do ia = 0, NA
                    ...
                    AA(it) = AA(it) + (a_plus(ia, ik, ix, ip, iw, ie, is, ij, itm)-xi*k_plus(ia, ik, ix, ip, iw, ie, is, ij, itm))*psi(is, ij)*m(ia, ik, ix, ip, iw, ie, is, ij, itm)/(1d0+n_p)
                    ...
                    bqs(is, it) = bqs(is, it) + (a_plus(ia, ik, ix, ip, iw, ie, is, ij, itm)+(1d0-xi)*k_plus(ia, ik, ix, ip, iw, ie, is, ij, itm))*(1d0-psi(is, ij))*m(ia, ik, ix, ip, iw, ie, is, ij, itm)/(1d0+n_p)
