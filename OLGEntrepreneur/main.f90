                ...
                do ix = 0, NX
                  do ik = 0, NK
                    do ia = 0, NA
                        ...
                        BQ = BQ + Q_plus(ia, ik, ix, ip, iw, ie, ij)*(1d0-psi(ij+1))*m(ia, ik, ix, ip, iw, ie, ij)/(1d0+n_p)
                        ...
                        if(ik == 0) then
                          ...
                          YE = YE + theta(ie)*(k(ik)**alpha*(eff(ij)*l(ia, ik, ix, ip, iw, ie, ij))**(1d0-alpha))**nu*m(ia, ik, ix, ip, iw, ie, ij) + (1d0-delta_k)*k(ia, ik, ix, ip, iw, ie, ij)*m(ia, ik, ix, ip, iw, ie, ij)
