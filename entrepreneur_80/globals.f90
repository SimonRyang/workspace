...
contains
  ...
  function valuefunc_w(xy)
    ...
    captax_com = taur(it_com)*1.055d0*max(r(it_com)*a(ia_com)-0.05d0*r(it_com)*a(ia_com)-2d0*0.0267d0*inc_bar(0), 0d0)
  ...
  function valuefunc_e(xy)
    ...
    captax_com = taur(it_com)*1.055d0*max(r(it_com)*max(a(ia_com)-k_com, 0d0) - 0.05d0*r(it_com)*max(a(ia_com)-k_com, 0d0) - 2d0*0.0267d0*inc_bar(0), 0d0)
