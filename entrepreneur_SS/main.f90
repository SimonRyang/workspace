...
program main
  ...
  sig_val(1, :) = (/0.370d0, 0.0365d0, 0.0375d0, 0.0360d0, 0.0380d0/)
  sig_val(2, :) = (/0.380d0, 0.0375d0, 0.0385d0, 0.0370d0, 0.0390d0/)
  sig_val(3, :) = (/0.395d0, 0.0390d0, 0.0400d0, 0.0385d0, 0.0405d0/)
