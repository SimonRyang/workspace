...
program main
  ...
  mu_val(1, :) =  (/0.450d0, 0.595d0, 0.605d0, 0.590d0, 0.610d0/)
  mu_val(2, :) =  (/0.400d0, 0.545d0, 0.565d0, 0.540d0, 0.560d0/)
  mu_val(3, :) =  (/0.250d0, 0.295d0, 0.305d0, 0.290d0, 0.310d0/)
  sig_val(1, :) = (/0.0370d0, 0.0365d0, 0.0375d0, 0.0360d0, 0.0380d0/)
  sig_val(2, :) = (/0.0380d0, 0.0375d0, 0.0385d0, 0.0370d0, 0.0390d0/)
  sig_val(3, :) = (/0.0390d0, 0.0385d0, 0.0395d0, 0.0380d0, 0.0400d0/)
  rho_val(1, :) = (/0.939d0, 0.939d0, 0.941d0, 0.936d0, 0.944d0/)
  rho_val(2, :) = (/0.936d0, 0.939d0, 0.941d0, 0.936d0, 0.944d0/)
