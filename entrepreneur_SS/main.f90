program main
  ...
  mu_val(2, :) =  0.55d0 !(/0.2245d0, 0.2250d0, 0.2255d0/)
  ...
  rho_val(1, :) = 0.940d0 !(/0.9400d0, 0.9405d0, 0.9410d0/)
  rho_val(2, :) = 0.940d0 !(/0.9400d0, 0.9405d0, 0.9410d0/)
  rho_val(3, :) = 0.941d0 !(/0.9400d0, 0.9405d0, 0.9410d0/)
...
contains
  ...
  subroutine get_distribution()
    ...
    do is = 1, NS
      do ie = 1, NE
        do iw = 1, NW
          m(0, 0, 0, 5, 5, is, 1) = dist_skill(is) !dist_eta(iw, is)*dist_theta(ie, is)*dist_skill(is)
        enddo ! iw
      enddo ! ie
    enddo ! is
