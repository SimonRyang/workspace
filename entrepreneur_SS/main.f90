...
program main
  ...
  mu_val(1, :) =  (/0.250d0, 0.595d0, 0.605d0, 0.590d0, 0.610d0/)
  mu_val(2, :) =  (/0.200d0, 0.545d0, 0.565d0, 0.540d0, 0.560d0/)
  ...
  sig_val(3, :) = (/0.0690d0, 0.0385d0, 0.0395d0, 0.0380d0, 0.0400d0/)
