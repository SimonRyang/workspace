...
program main
  ...
  mu_val(1, :) =  (/0.300d0, 0.595d0, 0.605d0, 0.590d0, 0.610d0/)
  mu_val(2, :) =  (/0.150d0, 0.545d0, 0.565d0, 0.540d0, 0.560d0/)
  mu_val(3, :) =  (/0.000d0, 0.295d0, 0.305d0, 0.290d0, 0.310d0/)
  sig_val(1, :) = (/0.00370d0, 0.0365d0, 0.0375d0, 0.0360d0, 0.0380d0/)
  sig_val(2, :) = (/0.00380d0, 0.0375d0, 0.0385d0, 0.0370d0, 0.0390d0/)
  sig_val(3, :) = (/0.00395d0, 0.0390d0, 0.0400d0, 0.0385d0, 0.0405d0/)
  rho_val(1, :) = (/0.840d0, 0.939d0, 0.941d0, 0.936d0, 0.944d0/)
  rho_val(2, :) = (/0.840d0, 0.939d0, 0.941d0, 0.936d0, 0.944d0/)
  rho_val(3, :) = (/0.841d0, 0.940d0, 0.942d0, 0.937d0, 0.945d0/)
