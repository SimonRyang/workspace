...
program main
  ...
  mu_val(2, :) =  (/0.550d0, 0.300d0, 0.100d0/)
  mu_val(3, :) =  (/0.300d0, 0.150d0, 0.000d0/)
  sig_val(1, :) = (/0.0365d0, 0.0450d0, 0.0600d0/)
  sig_val(2, :) = (/0.0370d0, 0.0450d0, 0.0600d0/)
  sig_val(3, :) = (/0.0390d0, 0.0450d0, 0.0600d0/)
  rho_val(1, :) = (/0.939d0, 0.850d0, 0.750d0/)
  rho_val(2, :) = (/0.936d0, 0.850d0, 0.750d0/)
  rho_val(3, :) = (/0.945d0, 0.850d0, 0.750d0/)
